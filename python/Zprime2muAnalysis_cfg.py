...
# See bockjoo CMSSW_12_3_0_pre4
process.load('Configuration.StandardSequences.FrontierConditions_GlobalTag_cff')
#bockjoo CMSSW_12_3_0_pre4 process.load('Configuration.StandardSequences.FrontierConditions_GlobalTag_condDBv2_cff')
# See bockjoo CMSSW_12_3_0_pre4
from Configuration.AlCa.GlobalTag import GlobalTag
#bockjoo CMSSW_12_3_0_pre4 from Configuration.AlCa.GlobalTag_condDBv2 import GlobalTag
