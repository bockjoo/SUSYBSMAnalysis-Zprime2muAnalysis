...
#process.source.fileNames =['root://cms-xrd-global.cern.ch//store/mc/RunIIAutumn18MiniAOD/ZToMuMu_NNPDF31_13TeV-powheg_M_4500_6000/MINIAODSIM/102X_upgrade2018_realistic_v15-v2/120000/CFAA5B09-4746-594F-9B1C-5F415F673C4E_Florida.root']
#process.source.fileNames =['root://cmsio2.rc.ufl.edu//store/mc/RunIIAutumn18MiniAOD/ZToMuMu_NNPDF31_13TeV-powheg_M_4500_6000/MINIAODSIM/102X_upgrade2018_realistic_v15-v2/120000/CFAA5B09-4746-594F-9B1C-5F415F673C4E_Florida.root']
process.source.fileNames =['/store/mc/RunIIAutumn18MiniAOD/ZToMuMu_NNPDF31_13TeV-powheg_M_4500_6000/MINIAODSIM/102X_upgrade2018_realistic_v15-v2/120000/CFAA5B09-4746-594F-9B1C-5F415F673C4E_Florida.root']
...
#10_6_17 from PhysicsTools.PatUtils.l1ECALPrefiringWeightProducer_cfi import l1ECALPrefiringWeightProducer
#12_3_0_pre4
...
if year == 2016 or year == 2017:
	...
	if year==2016:
    		process.prefiringweight.DataEraECAL = cms.string("2016BtoH")
...
#python2 for cut_name, Selection in cuts.iteritems():
for cut_name, Selection in cuts.items():
...
#         leptons.muon_track_for_momentum = cms.string('TunePNew')
    ...
    import functools # python3 for reduce
 	
    if year == 2016 or year == 2017:
        pobj = process.EventCounter* process.prefiringweight * process.dileptonPreselector *  process.muonPhotonMatchMiniAOD * functools.reduce(lambda x,y: x*y, path_list)
    else:
        pobj = process.EventCounter * process.dileptonPreselector *  process.muonPhotonMatchMiniAOD * functools.reduce(lambda x,y: x*y, path_list)
